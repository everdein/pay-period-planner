...
controls, horizontal table overflow, and incorrect navigation behavior at the
900-pixel breakpoint. Compact table layouts reflow into labeled detail rows
instead of relying on contained scrolling. Use
